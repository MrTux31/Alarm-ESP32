...
public:
    ...
    /**
     * @brief Permet de définir une fonction callback à appeler
     * lorsque le service de communication se connecte 
     * Par exemple : lorsque la connexion avec le serveur est établie
     */
